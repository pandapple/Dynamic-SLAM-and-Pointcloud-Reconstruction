        ...
        mbDeactivateLocalizationMode(false)
{
    ...
    mpPointCloudMapping = make_shared<PointCloudMapping>( resolution, mpMap);
    ...
    // Start point cloud mapping thread after YOLO initialization is complete
    mpPointCloudMapping->start();
