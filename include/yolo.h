...
class YOLO
{
	public:
		...
		cv::Mat detect(Mat& frame, std::vector<cv::Rect>& boxes, std::vector<int>& classIds, std::vector<float>& confidences);
		void initialize(double a, double b, double c, std::string str);
	private:
