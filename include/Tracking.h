...
public:
    ...
    cv::Mat mask;
    std::vector<cv::Rect> mPersonBoxes; // Detection boxes for people
    std::vector<int> mPersonClassIds; // Class IDs for detected objects
    std::vector<float> mPersonConfidences; // Confidences for detected objects
